...
{
    public static class DevelopConsoleConfigurationExtensions
    {
        ...
        public static LoggerConfiguration DevelopConsole(
            ...
            string outputTemplate = DefaultConsoleOutputTemplate)
        {
            ...
            return sinkConfiguration.Sink(new DevelopConsoleSink(formatter));
        }
