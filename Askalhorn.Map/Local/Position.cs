...
namespace Askalhorn.Map.Local
{
    ...
    public class Position: IPosition
    {
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String" /> representation of this <see cref="T:Askalhorn.Map.Local.Position" /> in the format:
        /// (X: <see cref="P:Askalhorn.Map.Local.Position.X" />, Y:<see cref="P:Askalhorn.Map.Local.Position.Y" />)
        /// </summary>
        /// <returns><see cref="T:System.String" /> representation of this <see cref="T:Askalhorn.Map.Local.Position" />.</returns>
